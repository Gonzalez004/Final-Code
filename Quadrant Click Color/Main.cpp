...
int main() {
	...
	while (1)
	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if (bouncer_x > 0 && bouncer_x < 250 && bouncer_y > 250 && bouncer_y < 500) {
				al_draw_filled_rectangle(0, 250, 250, 500, al_map_rgb(B, C, D));
			}
			if (bouncer_x > 250 && bouncer_x < 500 && bouncer_y > 0 && bouncer_y < 250) {
				al_draw_filled_rectangle(250, 0, 500, 250, al_map_rgb(B, C, D));
			}
