...
string Name() {
	string CarName[20] = { "Chevy","Alfo Romero","Land Rover","Kia","Ford","BMW","Mahindra","Toyota","Porche","Audi","Volkswagen","Lamborghini","Cadillac","Nissan","Bugatti","Mercades","GMC","Ferrari","Fiat","Hyundai" };
	int Num = rand() % 20;
	return CarName[Num];
}
int Fuel() {
